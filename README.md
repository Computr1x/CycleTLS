...
[![GoDoc](http://img.shields.io/badge/go-documentation-blue.svg)](http://godoc.org/github.com/Computr1x/CycleTLS/cycletls) 
...
[![Go Report Card](https://goreportcard.com/badge/github.com/Computr1x/CycleTLS/cycletls)](https://goreportcard.com/report/github.com/Computr1x/CycleTLS/cycletls)
...
```bash
$ go get github.com/Computr1x/CycleTLS/cycletls 
```
...
import (
	"log"
	"github.com/Computr1x/CycleTLS/cycletls"
)
